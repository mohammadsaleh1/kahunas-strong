...
export default function WorkoutLog() {
  const [exercises, setExercises] = useState<Exercise[]>([
    {
      ...
      type: 'bodyweight',
      sets: [
        { kg: '55', reps: '6', isCompleted: true, rpe: '' },
        { kg: '', reps: '', isCompleted: false, rpe: '' },
        { kg: '', reps: '', isCompleted: false, rpe: '' }
      ],
      targetReps: '12',
      restTime: '90',
    ...
    },
    {
      ...
      type: 'timed',
      sets: [{ kg: '', reps: '60', isCompleted: false, rpe: '' }],
      time: '03 min',
      heartRate: 4,
      letter: 'B',
      restTime: '60',
  ...
  const timerScale = scrollY.interpolate({
    inputRange: [0, 100],
    outputRange: [1, 0.85],
    extrapolate: 'clamp',
  });

  const timerPosition = scrollY.interpolate({
    inputRange: [0, 100],
    outputRange: [0, 30],
    extrapolate: 'clamp',
  });
  ...
  const handleAddSet = (exerciseId: string) => {
    setExercises(prev => prev.map(ex => {
      if (ex.id === exerciseId) {
        return {
          ...ex,
          sets: [...ex.sets, { kg: '', reps: '', isCompleted: false, rpe: '' }]
        };
      }
      return ex;
    }));
